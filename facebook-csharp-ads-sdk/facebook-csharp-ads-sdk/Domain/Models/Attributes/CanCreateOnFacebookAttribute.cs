...
{
    /// <summary>
    ///     Attribute used to indicate whether a property can be sent in the creation of Facebook
    /// </summary>
    [AttributeUsage(
        AttributeTargets.Field | AttributeTargets.Property | AttributeTargets.Method | AttributeTargets.Parameter,
        Inherited = false, AllowMultiple = false)]
    public class CanCreateOnFacebookAttribute : Attribute, IAttribute<bool>
    {
        #region Properties
        ...
        ///     Construtor base
        /// </summary>
        public CanCreateOnFacebookAttribute(bool value)
        {
            _value = value;
        }
