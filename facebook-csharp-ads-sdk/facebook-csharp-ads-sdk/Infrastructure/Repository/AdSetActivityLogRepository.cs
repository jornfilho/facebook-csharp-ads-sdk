...
{
    public class AdSetActivityLogRepository : IAdActivityLogRepository
    {
        #region Properties
        ...
        public AdSetActivityLogRepository(IFacebookSession facebookSession)
        {
        ...
        public async Task<IList<AdActivityLog>> Read(long id, IList<AdActivityLogFieldsEnum> fields)
        {
            ...
            string endpoint = this._facebookSession.GetFacebookAdsApiConfiguration().AdSetActivityLogEndpoint;
