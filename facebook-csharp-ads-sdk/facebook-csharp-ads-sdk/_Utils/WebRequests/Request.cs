...
namespace facebook_csharp_ads_sdk._Utils.WebRequests
{
    ...
    public class Request : IRequest
    {
        ...
        /// <exception cref="ArgumentOutOfRangeException"></exception>
        /// <returns>Request result</returns>
        public async Task<string> PostAsync(string url, NameValueCollection postData, int timeout)
        {
        ...
        /// <exception cref="ArgumentOutOfRangeException"></exception>
        /// <returns>Request result</returns>
        public async Task<string> PostAsync(string url, NameValueCollection postData)
        {
